            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Text(
                      'Help us keep Bolbro safe, fun, and respectful for everyone.',
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const Divider(height: 24),
                  _buildGuidelineItem(context, 'Use Bolbro Respectfully', 'Contribute positively to the community.', Icons.favorite_rounded),
                ],
              ),
            ),
            SizedBox(height: 40),
